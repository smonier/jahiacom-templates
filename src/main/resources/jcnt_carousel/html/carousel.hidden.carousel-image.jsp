        ...
        <div class="container">
            <div class="row">
                ...
                <c:if test="${! empty title}">
                    <h2 class="underline-primary d-inline w-auto pb-0">${title}</h2>
                </c:if>
                <div class="carousel-multiple-items arrows-style-2 mt-5" data-slick='{"arrows":true}'>
                    <c:forEach items="${subLists}" var="droppableContent" varStatus="status">
                        <div class="c-item">
                            <template:module node="${droppableContent}" editable="true" view="hidden.carousel-image"/>
                        </div>
                    </c:forEach>
                </div>
            </div>
