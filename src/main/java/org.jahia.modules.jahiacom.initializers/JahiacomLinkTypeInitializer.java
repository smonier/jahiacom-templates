...
@Component(name = "jahiacomLinkTypeInitializer", service = ModuleChoiceListInitializer.class, immediate = true)
public class JahiacomLinkTypeInitializer extends AbstractChoiceListRenderer implements ModuleChoiceListInitializer, ModuleChoiceListRenderer {

    private static final Logger logger = LoggerFactory.getLogger(JahiacomLinkTypeInitializer.class);

    private String key = "jahiacomLinkTypeInitializer";
